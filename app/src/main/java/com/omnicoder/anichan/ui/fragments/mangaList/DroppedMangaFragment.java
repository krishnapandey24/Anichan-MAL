...
@AndroidEntryPoint
public class DroppedMangaFragment extends Fragment implements MangaListAdapter.MyViewHolder.UpdateMangaList, UpdateMangaBottomSheet.UpdateManga{
    ...
    public static DroppedMangaFragment newInstance(){
        return new DroppedMangaFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getDropped().observe(getViewLifecycleOwner(), mangaList-> {
            MangaListAdapter adapter = new MangaListAdapter(getContext(), mangaList, this, this,4);
