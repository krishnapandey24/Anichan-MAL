...
@AndroidEntryPoint
public class PlanToReadFragment extends Fragment implements MangaListAdapter.MyViewHolder.UpdateMangaList, UpdateMangaBottomSheet.UpdateManga{
    ...
    public static PlanToReadFragment newInstance(){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.fetchPlanToRead(sortBy);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getPlanToRead().observe(getViewLifecycleOwner(), mangaList-> {
            MangaListAdapter adapter = new MangaListAdapter(getContext(), mangaList, this, this,1);
            recyclerView.setAdapter(adapter);
        });
        viewModel.getSortBy().observe(getViewLifecycleOwner(),sortBy -> viewModel.fetchPlanToRead(sortBy));
    }
