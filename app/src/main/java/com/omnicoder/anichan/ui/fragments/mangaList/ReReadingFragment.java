...
@AndroidEntryPoint
public class ReReadingFragment extends Fragment implements MangaListAdapter.MyViewHolder.UpdateMangaList, UpdateMangaBottomSheet.UpdateManga{
    ...
    public ReReadingFragment(){}

    public static ReReadingFragment newInstance(){
        return new ReReadingFragment();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.fetchReReading(sortBy);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSortBy().observe(getViewLifecycleOwner(),sortBy -> viewModel.fetchReReading(sortBy));
    }
