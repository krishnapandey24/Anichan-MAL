...
@AndroidEntryPoint
public class ReWatchingFragment extends Fragment implements AnimeListAdapter.MyViewHolder.UpdateAnimeList, UpdateAnimeBottomSheet.UpdateAnime {
    ...
    public ReWatchingFragment(){}

    public static ReWatchingFragment newInstance(){
        return new ReWatchingFragment();
    }
