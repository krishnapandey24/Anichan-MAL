...
@AndroidEntryPoint
public class OnHoldMangaFragment extends Fragment implements MangaListAdapter.MyViewHolder.UpdateMangaList, UpdateMangaBottomSheet.UpdateManga{
    ...
    public static OnHoldMangaFragment newInstance(){
        return new OnHoldMangaFragment();
    }
