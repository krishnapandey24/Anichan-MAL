...
public class AccountFragment extends Fragment  {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getUserInfo().observe(getViewLifecycleOwner(), userInfo -> {
            Picasso.get().load(userInfo.getPicture()).resize(160,160).into(binding.profileImageView);
        ...
        binding.aboutView.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_accountFragment_to_aboutFragment2));


        binding.settingsView.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_accountFragment_to_settingsFragment2));
