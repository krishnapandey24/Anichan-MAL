...
public class AnimePageAdapter extends PagingDataAdapter<ExploreView, AnimePageAdapter.MyViewHolder> {
    public static final int LOADING_ITEM = 0;
    public static final int ANIME_ITEM = 1;
    Context context;

    public AnimePageAdapter(DiffUtil.ItemCallback<ExploreView> diffCallBack,Context context){
        super(diffCallBack);
