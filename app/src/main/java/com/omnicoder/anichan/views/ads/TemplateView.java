package com.omnicoder.anichan.views.ads;
...
public class TemplateView extends FrameLayout {
  ...
  private ConstraintLayout superBackground;
  ...
  private void applyStyles() {
    ...
    if (mainBackground != null) {
      ...
      superBackground.setBackground(mainBackground);
      if (primaryView != null) {
  ...
  public void onFinishInflate() {
    ...
    superBackground=(ConstraintLayout) findViewById(R.id.superBackground);
