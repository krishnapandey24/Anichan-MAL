...
public class AccountListItemView extends ConstraintLayout {
    ...
    public AccountListItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray attributes=context.obtainStyledAttributes(attrs,R.styleable.AccountListItemView,0,0);
