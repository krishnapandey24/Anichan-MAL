...
public interface RxAPI {
    ...
    @GET("anime")
    Single<RankingResponse> searchAnime(@Header("Authorization") String accessToken, @Query("q") String query, @Query("limit") int limit,@Query("nsfw") Boolean nsfw, @Query("offset") int offset);
